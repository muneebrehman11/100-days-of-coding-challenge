...
guests1.forEach((guests)=>{
    console.log(`Dear ${guests}, I'm, inviting you for dinner tonight`);
...
while(guests1.length>2){
    let removed_guests= guests1.pop()
    
    console.log(`sorry dear ${removed_guests}, i can't invite you for the dinner!`);
}
guests1.forEach((guests)=>{
...
let fav_places:string[] = ['makkah', 'madina', 'paris', 'london', 'switzerland','japan']
console.log('original order:', fav_places); 
console.log('Alphabetical order:', [...fav_places].sort()); 
console.log('original order:', fav_places); 
console.log('reverse alphabetical order:', [...fav_places].reverse());
console.log('original order:', fav_places); 
fav_places.reverse()
...
fav_places.reverse()
console.log('Reverse alphabetical order:', fav_places);
