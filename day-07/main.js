...
var guests = ['tom', 'waseem', 'john', 'lewis', 'rudolf', 'henry', 'jeorj'];
console.log("i'm inviting ".concat(guests.length, " persons for the dinner"));
...
console.log('\n\n');
var cities = ['kashmeer', 'london', 'paris', 'dubai', 'instanbual'];
console.log("cities i'd like to travel ".concat(cities));
...
console.log("famous book: name: ".concat(book.name, " author:").concat(book.author, " published in:").concat(book.PublishedIn));
